package com.cmoc.config.shiro;

import com.cmoc.config.shiro.filters.CustomShiroFilterFactoryBean;
import com.cmoc.config.shiro.filters.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/srm/oa/**", "anon"); //oa接口
        filterChainDefinitionMap.put("/sys/cas/client/validateLogin", "anon"); //cas验证登录
        filterChainDefinitionMap.put("/sys/cas/client/validateLoginToZhlx", "anon"); //cas验证登录
