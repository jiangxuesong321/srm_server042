 ...
 * @Version: V1.0
 */
@ApiModel(value="bas_contract_template_article对象", description="合同条款表")
@Data
@TableName("bas_contract_template_article")
public class BasContractTemplateArticle implements Serializable {
	...
	/**条款序号*/
	@Excel(name = "条款序号", width = 15)
    @ApiModelProperty(value = "条款序号")
