...
import org.cmoc.common.constant.CacheConstant;
import org.cmoc.common.constant.CommonConstant;
import org.cmoc.common.system.vo.SysUserCacheInfo;
import org.cmoc.common.util.PasswordUtil;
import org.cmoc.common.util.UUIDGenerator;
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public Map<String, String> fetchDeptByUsername(SysUser sysUser) {
		return baseMapper.fetchDeptByUsername(sysUser);
	}
	 ...
	 */
	@Override
	public List<SysUser> getUserByRoleCode(String roleCode,String subject) {
		return baseMapper.getUserByRoleCode(roleCode,subject);
	}
	 ...
	 */
	@Override
	public Boolean checkPermission(String s,String username) {
		List<String> pList = baseMapper.checkPermission(s,username);
	 ...
	 */
	@Override
	public String fetchPermission(String username) {
		String pList = baseMapper.fetchPermission(username);
		return pList;
	}
	 ...
	 */
	@Override
	public String getTopNode(String deptId) {
		return baseMapper.getTopNode(deptId);
	}
