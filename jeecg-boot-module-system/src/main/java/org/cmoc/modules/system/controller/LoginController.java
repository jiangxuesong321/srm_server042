...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		//判断该用户是否允许外网登录
		String isOutNet = sysUser.getIsOutNet();
		String url = sysLoginModel.getUrl();
		if(url.contains("ppms.zhlxsemicon.com:8443") || url.contains("ppms-demo.zhlxsemicon.com:8443")){
			if(!"1".equals(isOutNet)){
				result.error500("该用户不允许外网访问");
				return result;
			}
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(PasswordUtil.encrypt("0116037", "123456", "53DYmKkz"));
	}
