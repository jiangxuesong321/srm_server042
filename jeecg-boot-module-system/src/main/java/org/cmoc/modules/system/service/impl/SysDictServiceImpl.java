...
import org.cmoc.modules.system.mapper.SysDictItemMapper;
import org.cmoc.modules.system.mapper.SysDictMapper;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	@Override
	public List<DictModelMany> getDictItemsByCodeList(List<String> dictCodeList) {
		List<DictModelMany> list = sysDictMapper.queryDictItemsByCodeList(dictCodeList);
		return list;
	}
