package org.cmoc.modules.srm.model;

import org.cmoc.modules.srm.entity.SupplierPermission;
 ...
 * @author: jeecg-boot
 */
public class SupplierPermissionTree implements Serializable {
	...
	public SupplierPermissionTree() {
	}

	public SupplierPermissionTree(SupplierPermission permission) {
		...
		if (!permission.isLeaf()) {
			this.children = new ArrayList<SupplierPermissionTree>();
		}
	...
	private List<SupplierPermissionTree> children;
	...
	public List<SupplierPermissionTree> getChildren() {
		return children;
	}

	public void setChildren(List<SupplierPermissionTree> children) {
