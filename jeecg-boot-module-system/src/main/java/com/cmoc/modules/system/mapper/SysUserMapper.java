package com.cmoc.modules.system.mapper;
...
import com.cmoc.modules.system.entity.SysRole;
...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
    Map<String, String> fetchDeptByUsername(@Param("query") SysUser sysUser);
	 ...
	 * @return
	 */
    List<SysUser> getUserByRoleCode(@Param("roleCode") String roleCode,@Param("subject") String subject);
	 ...
	 * @return
	 */
    List<String> checkPermission(@Param("s") String s,@Param("username") String username);
	 ...
	 * @return
	 */
	SysRole getRoleCodeByUserId(@Param("userId") String userId);
	 ...
	 * @return
	 */
	String fetchPermission(@Param("username") String username);
	 ...
	 * @return
	 */
	String getTopNode(@Param("deptId") String deptId);
}
