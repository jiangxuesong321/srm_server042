...
import com.cmoc.common.api.dto.OnlineAuthDTO;
import com.cmoc.common.api.dto.message.*;
import com.cmoc.common.aspect.UrlMatchEnum;
import com.cmoc.common.constant.CacheConstant;
import com.cmoc.common.constant.CommonConstant;
import com.cmoc.common.constant.DataBaseConstant;
...
import com.cmoc.common.system.vo.*;
import com.cmoc.common.util.SysAnnmentTypeEnum;
import com.cmoc.common.util.YouBianCodeUtil;
import com.cmoc.common.util.oConvertUtils;
import com.cmoc.modules.message.entity.SysMessageTemplate;
import com.cmoc.modules.message.handle.impl.EmailSendMsgHandle;
import com.cmoc.modules.message.service.ISysMessageTemplateService;
...
import com.cmoc.modules.system.util.SecurityUtil;
...
//			}
	...
	private void sendSysAnnouncement(String fromUser, String toUser, String title, String msgContent, String setMsgCategory) {
		...
		for(int i=0;i<userIds.length;i++) {
			if(oConvertUtils.isNotEmpty(userIds[i])) {
				SupplierAccount sysUser = iSupplierAccountService.getById(userIds[i]);
				if(sysUser==null) {
					continue;
				}
				SysAnnouncementSend announcementSend = new SysAnnouncementSend();
