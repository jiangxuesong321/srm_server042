package com.cmoc.modules.system.service;
...
public interface ISysUserService extends IService<SysUser> {
	 ...
	 * @return
	 */
    Map<String, String> fetchDeptByUsername(SysUser sysUser);
	 ...
	 * @return
	 */
    List<SysUser> getUserByRoleCode(String roleCode,String subject);
	 ...
	 * @return
	 */
    Boolean checkPermission(String s,String username);
	/**
	 * 当前用户是否存在该权限
	 * @param s
	 * @return
	 */
	String fetchPermission(String username);
	 ...
	 * @return
	 */
    String getTopNode(String deptId);
}
