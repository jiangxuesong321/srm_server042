package com.cmoc.modules.system.model;
...
public class SysDepartTreeModel implements Serializable{
	...
	public SysDepartTreeModel(SysDepart sysDepart) {
        ...
        this.contacter = sysDepart.getContacter();
        this.corporate = sysDepart.getCorporate();
        this.agent = sysDepart.getAgent();
        this.bankName = sysDepart.getBankName();
        this.bankAccount = sysDepart.getBankAccount();
        this.postCode = sysDepart.getPostCode();
        this.alias = sysDepart.getAlias();
    }
