package com.cmoc.modules.system.controller;
...
import com.cmoc.common.aspect.annotation.PermissionData;
import com.cmoc.common.constant.CommonConstant;
import com.cmoc.common.system.query.QueryGenerator;
import com.cmoc.common.system.util.JwtUtil;
import com.cmoc.common.system.vo.LoginUser;
import com.cmoc.common.util.ImportExcelUtil;
import com.cmoc.common.util.PasswordUtil;
import com.cmoc.common.util.RedisUtil;
import com.cmoc.common.util.oConvertUtils;
import com.cmoc.modules.base.service.BaseCommonService;
import com.cmoc.modules.system.entity.*;
import com.cmoc.modules.system.model.DepartIdModel;
import com.cmoc.modules.system.model.SysUserSysDepartModel;
import com.cmoc.modules.system.service.*;
import com.cmoc.modules.system.vo.SysDepartUsersVO;
import com.cmoc.modules.system.vo.SysUserRoleVO;
...
//	}
     ...
     * @return
     */
    @GetMapping("/fetchDeptByUsername")
    public Map<String,String> fetchDeptByUsername(SysUser sysUser){
        return sysUserService.fetchDeptByUsername(sysUser);
    }
    ...
    public Result<?> getUserByOrgId(SysUser sysUser){
        List<SysUser> userList = sysUserService.list(Wrappers.<SysUser>query().lambda().
                eq(SysUser :: getDelFlag,CommonConstant.DEL_FLAG_0).
                eq(SysUser :: getDepartIds,sysUser.getDepartIds()).
                eq(SysUser :: getStatus,CommonConstant.ACT_SYNC_1));
    ...
    public Result<?> getUserByRoleCode(@RequestParam(name = "roleCode", required = false) String roleCode,@RequestParam(name = "subject", required = false) String subject){
        List<SysUser> userList = sysUserService.getUserByRoleCode(roleCode,subject);
        return Result.ok(userList);
    }
     ...
     * @return
     */
    @GetMapping("/getRoleCodeByUserId")
    public Result<?> getRoleCodeByUserId(){
        LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
        String userId = loginUser.getId();
        SysRole userList = sysUserService.getRoleCodeByUserId(userId);
        return Result.ok(userList);
    }
}
