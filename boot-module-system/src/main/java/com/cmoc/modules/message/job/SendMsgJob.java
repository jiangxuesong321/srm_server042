package com.cmoc.modules.message.job;

import java.util.List;

import com.cmoc.modules.message.handle.ISendMsgHandle;
import com.cmoc.modules.message.handle.enums.SendMsgStatusEnum;
import com.cmoc.modules.message.handle.enums.SendMsgTypeEnum;
import com.cmoc.modules.message.service.ISysMessageService;
import com.cmoc.common.util.DateUtils;
import com.cmoc.modules.message.entity.SysMessage;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" Jeecg-Boot 发送消息任务 SendBiddingMsgJob !  时间:" + DateUtils.getTimestamp()));
